...
public class FlowableObserverActivity extends AppCompatActivity {
     ...
     *
     * Được sử dụng khi một Observable tạo ra số lượng lớn các sự kiện/dữ liệu mà Observer có thể xử lý. Flowable có thể được sử dụng
     * khi nguồn tạo ra 10k+ sự kiện và Onserver không thể tiêu thụ tất cả. Flowable sử dụng phương pháp Backpressure để xử lý dữ liệu
     * tránh lỗi MissingBackpressureException và OutOfMemoryError.
     */
